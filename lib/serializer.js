...
export default CoreObject.extend({
  ...
  serializeAttributes(record, options) {
    ...
    this.attributes.forEach((attributeName) => {
      ...
      let rawValue = options.adapter.attributeFromRecord(record, attributeName, options);
  ...
  serializeRelationships(record, options) {
    ...
    forOwn(this.relationships, (relationshipConfig, relationshipName) => {
      ...
      let adapterData = options.adapter.relationshipFromRecord(record, relationshipName, relationshipConfig, options);
  ...
  serializerFor(record, options) {
    let type = options.adapter.typeForRecord(record, options);
