...
export default Renderer.extend({
  ...
  attributesForRecord(record, options) {
    ...
    return this.serializers[type].serializeAttributes(attributes, record, options);
  },

  relationshipsForRecord(record, options) {
    let type = this.typeForRecord(record, options);
    let relationships = this.adapter.relationshipsForRecord(record, options);
    relationships = this.serializers[type].serializeRelationships(relationships, record, options);
